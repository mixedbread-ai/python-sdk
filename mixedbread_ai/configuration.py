...
conf = mixedbread_ai.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.mixedbread.ai" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("mixedbread_ai")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'MIXEDBREADAI_API_KEY' in self.api_key:
            auth['MIXEDBREADAI_API_KEY'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
